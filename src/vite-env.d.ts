...
declare module '@sqlite.org/sqlite-wasm' {
	...
	export declare class JsStorageDb extends DatabaseApi {
		constructor (mode: 'local' | 'session');
		storageSize (): number;
		clearStorage (): void;
	}

	export declare class OpfsDatabase extends DatabaseApi {
		constructor (filename: string);
	}

	export type Flags = 'c' | 'w' | 'r' | 't';

	export declare class Database extends DatabaseApi {
